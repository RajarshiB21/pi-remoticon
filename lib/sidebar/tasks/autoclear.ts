// Adapted from https://github.com/tintinweb/pi-tasks (MIT, (c) 2026 tintinweb) src/auto-clear.ts.
// Deltas: the store import path is "./store.js". Everything else is upstream's.
/**
 * Turn-based auto-clearing of completed tasks.
 *
 * Two modes:
